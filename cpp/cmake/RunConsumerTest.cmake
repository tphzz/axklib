...
execute_process(
  COMMAND "${AXK_TEST_ROOT}/build/axk_c_consumer"
  RESULT_VARIABLE c_run_result
)
if(NOT c_run_result EQUAL 0)
  message(FATAL_ERROR "external C axklib consumer returned ${c_run_result}")
endif()
...
if(UNIX AND NOT APPLE)
  execute_process(
    COMMAND
      "${CMAKE_COMMAND}" -E env
      "PKG_CONFIG_PATH=${AXK_TEST_ROOT}/install/lib/pkgconfig"
      "LD_LIBRARY_PATH=${AXK_TEST_ROOT}/install/lib"
      sh -c
      "cc '${AXK_CONSUMER_SOURCE_DIR}/c_main.c' -o '${AXK_TEST_ROOT}/pkg-consumer' $(pkg-config --cflags --libs axklib) && '${AXK_TEST_ROOT}/pkg-consumer'"
    RESULT_VARIABLE pkg_result
  )
  if(NOT pkg_result EQUAL 0)
    message(FATAL_ERROR "pkg-config C consumer returned ${pkg_result}")
  endif()
endif()
