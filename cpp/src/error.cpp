...
std::string_view category_name(ErrorCategory category) {
  switch (category) {
    ...
    case ErrorCategory::container: return "container";
    case ErrorCategory::allocation: return "allocation";
    case ErrorCategory::object: return "object";
    case ErrorCategory::relationship: return "relationship";
    case ErrorCategory::audio: return "audio";
    case ErrorCategory::manifest: return "manifest";
...
std::string render_error(const Error& error, bool include_trace) {
  ...
  const bool has_context = context.partition_index || context.volume_name ||
                           context.object_type || context.object_name ||
