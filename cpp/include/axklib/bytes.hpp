...
class AXK_API ByteReader {
 public:
  ...
  [[nodiscard]] Result<std::string> ascii_field(
      std::size_t offset,
      std::size_t count,
      bool replace_invalid = true) const;
  [[nodiscard]] Result<std::string> printable_ascii_field(
      std::size_t offset,
      std::size_t count) const;
  [[nodiscard]] Result<std::string> decoded_ascii_field(
      std::size_t offset,
      std::size_t count) const;
...
class AXK_API ByteWriter {
 public:
  ...
  [[nodiscard]] Result<void> write_ascii_field(
      std::size_t offset,
      std::size_t count,
