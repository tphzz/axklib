...
TEST(Utf8, AcceptsScalarBoundariesNoncharactersAndEmbeddedNul) {
  for (const auto &value :
       {std::string{"ascii"}, std::string{"\0", 1U}, std::string{"\xc2\x80", 2U},
        std::string{"\xe0\xa0\x80", 3U}, std::string{"\xef\xb7\x90", 3U},
        std::string{"\xf0\x90\x80\x80", 4U}, std::string{"\xf4\x8f\xbf\xbf", 4U}}) {
...
TEST(Utf8, RejectsOverlongTruncatedSurrogateAndOutOfRangeSequences) {
  for (const auto &value :
       {std::string{"\x80", 1U}, std::string{"\xc0\x80", 2U}, std::string{"\xc2", 1U},
        std::string{"\xe0\x80\x80", 3U}, std::string{"\xed\xa0\x80", 3U},
        std::string{"\xf0\x80\x80\x80", 4U}, std::string{"\xf4\x90\x80\x80", 4U},
