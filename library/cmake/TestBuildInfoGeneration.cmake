...
foreach(required_variable IN ITEMS AXK_BUILD_INFO_GENERATOR AXK_BUILD_INFO_MODULE
                                   AXK_BUILD_INFO_TEMPLATE AXK_TEST_ROOT)
...
function(generate repository output_cpp output_package)
  execute_process(
...
generate("${repository}" "${output_cpp}" "${output_package}")
...
if(NOT initial_cpp_timestamp STREQUAL repeated_cpp_timestamp OR
   NOT initial_package_timestamp STREQUAL repeated_package_timestamp)
