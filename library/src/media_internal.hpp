...
[[nodiscard]] Result<std::vector<std::byte>> read_bytes(const RandomAccessReader &reader,
...
read_yamaha_iso_menu_labels(const IsoImage &image, const CancellationToken &cancellation);
