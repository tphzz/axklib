...
const std::array descriptors{
    ...
    OperationDescriptor{"package.inspect",
                        ...
                        "PackageReadRequest",
                        "PackageInspection"},
    OperationDescriptor{"audio.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/audio-inspections",
                        ExecutionMode::request,
                        {},
                        ...
                        false,
                        false},
    OperationDescriptor{"midi.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/midi-inspections",
                        ExecutionMode::request,
                        {},
                        ...
                        false,
                        false},
    OperationDescriptor{"images.tx16w.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-tx16w-import-inspections",
                        ExecutionMode::request,
                        {},
    ...
    OperationDescriptor{"package.plan_import",
                        ...
                        "PackageImportPlan"},
    OperationDescriptor{"package.plan_import.release",
                        {},
                        HttpMethod::post,
                        "/api/v1/package-import-plan-releases",
                        ExecutionMode::request,
                        {},
                        "PlanTokenRequest",
                        "PlanReleaseResult",
    ...
    OperationDescriptor{"package.import",
                        ...
                        OperationClass::write,
                        true},
    OperationDescriptor{"images.package_import.plan",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-package-import-plans",
                        ExecutionMode::request,
                        {},
                        ...
                        false,
                        false},
    OperationDescriptor{"images.package_import.release",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-package-import-plan-releases",
                        ExecutionMode::request,
                        {},
                        "PlanTokenRequest",
                        "PlanReleaseResult",
                        ...
                        false,
                        false},
    OperationDescriptor{"images.package_import",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-package-imports",
                        ExecutionMode::job,
                        {},
                        "PackageImportRequest",
                        ...
                        true,
                        false},
    OperationDescriptor{"images.package_export",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-package-exports",
                        ExecutionMode::job,
                        {},
                        "ImageSessionPackageExportRequest",
                        "ImageSessionPackageExportResult",
                        OperationClass::write,
                        true,
                        false},
    OperationDescriptor{"images.volume_package_export.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-volume-package-export-inspections",
                        ExecutionMode::request,
                        {},
                        "ImageSessionVolumePackageExportInspectionRequest",
                        "ImageSessionVolumePackageExportInspection",
                        OperationClass::read,
                        false,
                        false},
    OperationDescriptor{"images.volume_package_export",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-volume-package-exports",
                        ExecutionMode::job,
                        {},
                        "ImageSessionVolumePackageExportRequest",
                        "ImageSessionVolumePackageExportResult",
                        OperationClass::write,
                        true,
                        false},
    OperationDescriptor{"images.volume_floppy_export.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-volume-floppy-export-inspections",
                        ExecutionMode::request,
                        {},
                        "ImageSessionVolumeFloppyExportInspectionRequest",
                        "ImageSessionVolumeFloppyExportInspection",
                        OperationClass::read,
                        false,
                        false},
    OperationDescriptor{"images.volume_floppy_export",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-volume-floppy-exports",
                        ExecutionMode::job,
                        {},
                        "ImageSessionVolumeFloppyExportRequest",
                        "ImageSessionVolumeFloppyExportResult",
                        OperationClass::write,
                        true,
                        false},
    OperationDescriptor{"images.audio_export.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-audio-export-inspections",
                        ExecutionMode::request,
                        {},
                        ...
                        false,
                        false},
    OperationDescriptor{"images.audio_export",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-audio-exports",
                        ExecutionMode::job,
                        {},
                        ...
                        true,
                        false},
    OperationDescriptor{"images.sequence_export",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-sequence-exports",
                        ExecutionMode::job,
                        {},
                        ...
                        true,
                        false},
    OperationDescriptor{"images.media_conversion.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-media-conversion-inspections",
                        ExecutionMode::request,
                        {},
                        "ImageSessionMediaConversionInspectionRequest",
                        "ImageSessionMediaConversionInspection",
                        OperationClass::read,
                        false,
                        false},
    OperationDescriptor{"images.media_conversion",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-media-conversions",
                        ExecutionMode::job,
                        {},
                        "ImageSessionMediaConversionRequest",
                        "ImageSessionMediaConversionResult",
                        OperationClass::write,
                        true,
                        false},
    OperationDescriptor{"images.extent_layout.repair",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-session-extent-layout-repairs",
                        ExecutionMode::job,
                        {},
                        ...
                        true,
                        false},
    OperationDescriptor{"files.archive",
                        {},
                        HttpMethod::post,
    ...
    OperationDescriptor{"create.plan",
                        ...
                        false,
                        false},
    OperationDescriptor{"create.hds.profiles",
                        {},
                        HttpMethod::get,
                        "/api/v1/hard-disk-creation-profiles",
                        ExecutionMode::request,
                        {},
                        "EmptyRequest",
                        ...
                        false,
                        false},
    OperationDescriptor{"create.hds.plan",
                        {},
                        HttpMethod::post,
                        "/api/v1/hard-disk-build-plans",
                        ExecutionMode::request,
                        {},
                        ...
                        false,
                        false},
    OperationDescriptor{"create.floppy.plan",
                        {},
                        HttpMethod::post,
                        "/api/v1/floppy-build-plans",
                        ExecutionMode::request,
                        {},
                        "FloppyCreationPlanRequest",
                        "ImageBuildPlan",
                        OperationClass::read,
                        false,
                        false},
    ...
    OperationDescriptor{"alter.inspect",
                        {},
                        HttpMethod::post,
    ...
    OperationDescriptor{"alter.hds",
                        ...
                        OperationClass::write,
                        true},
    OperationDescriptor{"images.alter",
                        {},
                        HttpMethod::post,
                        ...
                        "ImageSessionAlterationResult",
                        OperationClass::write,
                        true,
                        false},
    OperationDescriptor{"images.deletion.inspect",
                        {},
                        HttpMethod::post,
                        ...
                        false,
                        false},
    OperationDescriptor{"images.volume_deletion.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-volume-deletion-inspections",
                        ExecutionMode::request,
                        {},
                        ...
                        false,
                        false},
    OperationDescriptor{"images.placement.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-object-placement-inspections",
                        ExecutionMode::request,
                        {},
                        "ImagePlacementInspectionRequest",
                        "ImagePlacementInspection",
                        OperationClass::read,
                        false,
                        false},
    OperationDescriptor{"images.placement.repair",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-object-placement-repairs",
                        ExecutionMode::job,
                        {},
                        ...
                        true,
                        false},
    OperationDescriptor{"images.deletion.orphans.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-wave-data-orphan-inspections",
                        ExecutionMode::request,
                        {},
                        "ImageWaveDataOrphanInspectionRequest",
                        "ImageWaveDataOrphanInspection",
                        OperationClass::read,
                        false,
                        false},
    OperationDescriptor{"images.programs.generate.inspect",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-program-generation-inspections",
                        ExecutionMode::request,
                        {},
                        "ImageProgramGenerationInspectionRequest",
                        "ImageProgramGenerationInspection",
                        OperationClass::read,
                        false,
                        false},
    OperationDescriptor{"images.programs.generate",
                        {},
                        HttpMethod::post,
                        "/api/v1/image-program-generations",
                        ExecutionMode::job,
                        {},
                        "ImageProgramGenerationRequest",
                        "ImageProgramGenerationResult",
                        OperationClass::write,
                        true,
                        false},
    OperationDescriptor{"images.delete",
                        {},
                        HttpMethod::post,
